...
namespace PayFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260509234502_AddTopUpAndLedgerSource")]
    partial class AddTopUpAndLedgerSource
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayFlow.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<Guid>("ReceiverTenantId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PayFlow.Domain.Entities.TopUp", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PayFlow.Domain.Entities.LedgerEntry", b =>
                {
                    b.HasOne("PayFlow.Domain.Entities.Wallet", "Wallet")
            ...
            modelBuilder.Entity("PayFlow.Domain.Entities.Payment", b =>
                {
                    b.HasOne("PayFlow.Domain.Entities.Wallet", null)
                        .WithMany()
